    ...
    render () {
        ...
        return <Pane 
            ...
            <Pane display="flex">
                ...
                <Badge backgroundColor="#e7e9ef" width="120px" fontWeight="bold" borderRadius={16} paddingLeft={10} fontSize={11} paddingRight={10} marginLeft={10} marginTop={3}>3da3ad7b90e3</Badge>
